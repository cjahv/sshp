...
public interface Page {
   ...
   */
  <T extends BaseEntityImpl> DataFilter<T> filter(Class<T> entityClass);
   ...
   * @return PageResult
   */
  <T extends BaseEntityImpl> PageResult<T> getResult(List<T> list, Integer count, Integer countTail);
