...
import com.sshp.plugins.hibernate.core.impl.FilterCondition;
...
public class Filter implements FilterCondition {
  private String name;
  ...
  public static Other all() {
    return Other.all;
  }

  public static Other one() {
    return Other.one;
  }

  public static Other length(int length) {
    return new Other(2, 0, length);
  }

  public static Other length(int start, int length) {
    return new Other(2, start, length);
  }
}
